<script setup lang="ts">
  ...
  const laporanManage = authStore.hasPermission({
    olahraga_seni: ["manage"],
  });
  constantStore.setTitle("Olahraga & Seni / Laporan Bidang");
  ...
  async function clickDelete(ids: number[]) {
    openConfirmModal(
      ...
      { id: ids, musyawarahId: musyId, bidang: "olahraga_seni" },
      refresh
    );
  }
...
<template>
  <Title>Olahraga & Seni | Laporan Bidang</Title>
  <LazyUModal
