<script setup lang="ts">
  ...
  constantStore.setTitle("Penggalang Dana / Daftar Musyawarah Bidang");

  const state = ref(getInitialFormData());
  const query = reactive({
    search: "",
    page: 1,
    bidang: "penggalang_dana",
  });
...
<template>
  <Title>Penggalang Dana | Daftar Musyawarah Bidang</Title>
  <main>
    <LazyUModal
    ...
    <UCard>
      <div class="mb-6 flex gap-2 md:gap-4">
        ...
        <AppTambahExport
          ...
          path="musyawarah-bidang/export?bidang=penggalang_dana"
        />
      </div>
      <AppTable
