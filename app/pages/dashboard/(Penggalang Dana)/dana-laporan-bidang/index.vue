<script setup lang="ts">
  ...
  const laporanManage = authStore.hasPermission({
    penggalang_dana: ["manage"],
  });
  constantStore.setTitle("Penggalang Dana / Laporan Bidang");
  ...
  async function clickDelete(ids: number[]) {
    openConfirmModal(
      ...
      { id: ids, musyawarahId: musyId, bidang: "penggalang_dana" },
      refresh
    );
  }
...
<template>
  <Title>Penggalang Dana | Laporan Bidang</Title>
  <LazyUModal
