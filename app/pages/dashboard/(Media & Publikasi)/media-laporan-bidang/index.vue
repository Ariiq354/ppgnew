<script setup lang="ts">
  ...
  const laporanManage = authStore.hasPermission({
    media_publikasi: ["manage"],
  });
  constantStore.setTitle("Media & Publikasi / Laporan Bidang");
  ...
  async function clickDelete(ids: number[]) {
    openConfirmModal(
      ...
      { id: ids, musyawarahId: musyId, bidang: "media_publikasi" },
      refresh
    );
  }
...
<template>
  <Title>Sekretariat | Laporan Bidang</Title>
  <LazyUModal
