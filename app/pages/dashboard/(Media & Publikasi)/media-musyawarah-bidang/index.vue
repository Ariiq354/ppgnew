<script setup lang="ts">
  ...
  constantStore.setTitle("Media & Publikasi / Daftar Musyawarah Bidang");

  const state = ref(getInitialFormData());
  const query = reactive({
    search: "",
    page: 1,
    bidang: "media_publikasi",
  });
...
<template>
  <Title>Media & Publikasi | Daftar Musyawarah Bidang</Title>
  <main>
    <LazyUModal
    ...
    <UCard>
      <div class="mb-4 flex gap-2 md:mb-6 md:gap-4">
        ...
        <AppTambahExport
          ...
          path="musyawarah-bidang/export?bidang=media_publikasi"
        />
      </div>
      <AppTable
