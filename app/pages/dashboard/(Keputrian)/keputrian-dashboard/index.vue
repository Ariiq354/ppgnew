<script setup lang="ts">
  ...
  constantStore.setTitle("Keputrian / Dashboard");

  const { data } = await useFetch(`${APIBASE}/dashboard/keputrian`);
</script>

<template>
  <Title>Keputrian | Dashbaord</Title>
  ...
  <main class="grid grid-cols-1 gap-4 md:grid-cols-4 md:gap-8">
    ...
    />
    <NuxtLink class="md:col-span-4" to="/dashboard/keputrian-generus">
      <CountCard
        title="Generus"
