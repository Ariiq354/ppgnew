<script setup lang="ts">
  ...
  constantStore.setTitle("Sarana Prasarana / Daftar Musyawarah Bidang");
  ...
  async function clickDelete(ids: number[]) {
    openConfirmModal(
      "/musyawarah-bidang",
      { id: ids, bidang: "sarana_prasarana" },
      refresh
    );
  }
...
<template>
  <Title>Sarana Prasarana | Daftar Musyawarah Bidang</Title>
  <main>
    <LazyUModal
    ...
    <UCard>
      <div class="mb-4 flex gap-2 md:mb-6 md:gap-4">
        ...
        <AppTambahExport
          ...
          path="musyawarah-bidang/export?bidang=sarana_prasarana"
        />
      </div>
      <AppTable
