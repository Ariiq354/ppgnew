<script setup lang="ts">
  ...
  constantStore.setTitle("Kurikulum / Daftar Musyawarah Bidang");
...
<template>
  <Title>Kurikulum | Daftar Musyawarah Bidang</Title>
  <main>
    <LazyUModal
    ...
    <UCard>
      <div class="mb-6 flex gap-2 md:gap-4">
        ...
        <AppTambahExport
          ...
          path="musyawarah-bidang/export?bidang=kurikulum"
        />
      </div>
      <AppTable
