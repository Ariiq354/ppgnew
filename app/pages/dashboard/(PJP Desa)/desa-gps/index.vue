<script setup lang="ts">
  ...
  constantStore.setTitle("PJP Desa / GPS");
  ...
  const { data, status } = await useFetch(`${APIBASE}/generus/gps`, {
    query,
  });
  ...
  <main>
    ...
    <UCard>
      <div class="mb-4 flex gap-2 md:mb-6 md:gap-4">
        ...
        />
        <AppTambahExport path="generus/export/gps" />
      </div>
      <AppTable
